...
function getDailyTrend(data) {
    try {
        console.log('getDailyTrend 開始:', data.length, '件');
        const dailyCounts = {};
        const validDates = [];
        let postcardCount = 0;
        ...
        console.log('日付データ:', validDates.length, '件');
        console.log('ハガキデータ:', postcardCount, '件');
        ...
        console.log('ユニーク日付数:', sortedDates.length);
        ...
        console.log('getDailyTrend 完了:', result.length, '件');
        console.log('最初の3件:', result.slice(0, 3));
